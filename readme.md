...
```
https://raw.githubusercontent.com/Cxsmo-ai/easyjews/main/manifest.json
```

The manifest points Syncler to:

```
https://raw.githubusercontent.com/Cxsmo-ai/easyjews/main/package.json
```
